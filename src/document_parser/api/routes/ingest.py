...
from document_parser import Chunk, ChunkingConfig, DocumentParserError, IngestPipeline
...
async def ingest_document(
    ...
    try:
        return await pipeline.aingest(file.filename or "upload", data=data, config=config)
