...
_TABLE_PROMPT = (
    "Summarize the content and structure of this table in 2-4 concise sentences. "
    "Mention the key columns/rows and any notable values. Do not output HTML or "
    "markdown table syntax — plain prose only."
)
